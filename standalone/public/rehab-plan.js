...
const therapistManagementPanel = document.querySelector('.therapist-management-panel');
if (therapistManagementPanel && rehabPlanSection) therapistManagementPanel.insertAdjacentElement('afterend', rehabPlanSection);
